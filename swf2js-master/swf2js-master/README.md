...
- Added support for external access/control (functions: play, step stop, showInfo, showDebug)
- Corrected support for touch/non-touch devices
- Corrected previous frame, trying to go to a frame < 1
- Corrected ActionScript 1/2
    - Now working: onEnterFrame, loadSound, attachSound, onSoundComplete
